...
export default function Wordle() {
    ...
    return <div tabIndex={-1} onKeyDown={handleKeyDown} className="flex grow flex-col justify-center pb-6 short:pb-2" >
        <Grid currentRowClassName='test' guesses={triedGuess} currentGuess={guess} solution={solution} isRevealing={false} />

        <div>
            <button onClick={handleNewGame}>New</button>
        </div>
        <div><h1>You are {gameEnd}</h1></div>
    </div>
